odoo.define('contabilidad_cfdi.account_financial_report_backend', function (require) {
'use strict';

var core = require('web.core');
var Widget = require('web.Widget');
var ControlPanelMixin = require('web.ControlPanelMixin');
var ReportWidget = require('contabilidad_cfdi.account_financial_report_widget');
...
var report_backend = Widget.extend(ControlPanelMixin, {
    // Stores all the parameters of the action.
     events: {
        ...
        'click .o_account_financial_reports_generar_xml': 'generar_xml',
    },
    ...
    generar_xml: function () {
        return this.do_action({
            name: "Generar XML Hirarchy",
