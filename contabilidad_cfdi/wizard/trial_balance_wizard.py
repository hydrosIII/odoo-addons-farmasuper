...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    _name = "trial.balance.report.wizard.contabilidad.cfdi"
...
#     date_to = fields.Date(required=True)
    ...
    account_ids = fields.Many2many(
        comodel_name='account.account',relation='account_trial_balance_report_wizard_contabilidad_cfdi_rel',
    ...
    cuentas_de_orden = fields.Boolean('Cuentas de orden')
...
#                       'Date Range must be the same.'))
    ...
    @api.multi
    def button_view_accounts_html(self):
        self.ensure_one()
